...
camera_create_ray {
  ...
  switch (camera_data->cameraType){
    ...
    { 
      ...
      camera_data->trace_ray_fw_po(true, tries, input.sx, input.sy, input.lensx, input.lensy, random1, random2, weight, origin, direction);
      ...
      if (tries > 0){
        ...
        camera_data->trace_ray_fw_po(false, tries, input_dx.sx, input_dx.sy, random1, random2, random1, random2, out_dx_weight, out_dx_origin, out_dx_dir);
        ...
        camera_data->trace_ray_fw_po(false, tries, input_dy.sx, input_dy.sy, random1, random2, random1, random2, out_dy_weight, out_dy_origin, out_dy_dir);
    ...
    case ThinLens:
    {
      ...
      camera_data->trace_ray_fw_thinlens(true, tries, input.sx, input.sy, input.lensx, input.lensy, origin, dir, weight, r1, r2);
      ...
      if (tries > 0){
          ...
          camera_data->trace_ray_fw_thinlens(false, tries, input_dx.sx, input_dx.sy, r1, r2, output_dx.origin, output_dx.dir, output_dx.weight, r1, r2);
          camera_data->trace_ray_fw_thinlens(false, tries, input_dy.sx, input_dy.sy, r1, r2, output_dy.origin, output_dy.dir, output_dy.weight, r1, r2);
